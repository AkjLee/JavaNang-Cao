 ...
 <h2 style="text-align:center">ĐĂNG KÝ THÀNH VIÊN</h2><table align="center">
                 ...
                 <form action="ktdkController" style="width: 742px;height: 542px; margin-left: 30px" method="post">
			        <div style="width: 740px; height: 30px;margin-top: 10px; margin-left: 525px">
					 ...
					 <div style="width: 740px; height: 30px;margin-top: 10px; margin-left: 525px">
						<input name="phone" type="text" style="padding: 3px;float: left;width: 295px;color: #000;font-size: 15px;margin-right: 10px;height: 30px;" placeholder="Nhập số điện thoại" aria-label="Nhập số điện thoại">
					</div>
					 <div style="width: 740px; height: 30px;margin-top: 10px; margin-left: 525px">
					...
					<div style="width: 740px; height: 30px;margin-top: 10px; margin-left: 525px">
						<input name="TenDN" type="text" style="padding: 3px;float: left;width: 295px;color: #000;font-size: 15px;margin-right: 10px;height: 30px;" placeholder="Nhập tên đăng nhập" aria-label="Nhập tên đăng nhập">
					</div>
					<div style="width: 740px; height: 30px;margin-top: 10px; margin-left: 525px">
						<input name="Matkhau" type="password" style="padding: 3px;float: left;width: 295px;color: #000;font-size: 15px;margin-right: 10px;height: 30px;" placeholder="Nhập mật khẩu" aria-label="Nhập mật khẩu">
					</div>
						<div style="width: 740px; height: 30px;margin-top: 10px; margin-left: 525px">
