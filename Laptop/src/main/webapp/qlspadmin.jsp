...
<!-- 									<p>Noi dung</p>
 -->								
					...
					<div class="w3l-table-info">
					  <h2 style="color:#2196F3; text-align: center; ">Thêm sản phẩm</h2>
					  <hr>
					  <div class="row">
					  	...
					  	<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
							  ...
							  <input type="text" class="form-control" name="txtname" id="tensp">
							</div>
							<div class="form-group">
							  <label >Ảnh:</label>
							...
							<div class="form-group">
							  ...
							  <input type="text" class="form-control" name="catelory" id="CateID">
							</div>
							<button type="submit" class="btn btn2">Thêm sản phẩm</button>
							</form>
							 <hr>
					  	</div>
					  	<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
					  ...
					  <h2 style="color:#2196F3; text-align: center;">Cập nhật sản phẩm</h2>
					  <hr>
...
<tr class="info">
							...
							<a href="loadSP?id=<%=s.getId()%>"class="btn"  > Sửa </a>
							<a class="btn btn3" href="xoasanpham?masp=<%=s.getId()%>"> Xóa</a>
